...
@pytest.mark.parametrize(
    ...
    [
        "123",
        "6011223344556677889900",
        "",
        "6011e2345678"
    ],
)
def test_invalid_phone_number_rejected(driver, invalid_phone_number):
    ...
    phone.clear(); phone.send_keys(invalid_phone_number)
    ...
    try:
        ...
        wait_short.until(lambda d: phone.get_attribute('validationMessage') and phone.get_attribute('validationMessage') != '')
        ...
        try:
            ...
            pytest.fail('Form succeeded unexpectedly for invalid phone number')
        except TimeoutException:
