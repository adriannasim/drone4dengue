...
def test_edit_drone_image_metadata_empty(driver):
    ...
    # 5. Edit the image (Image1) metadata/notes without providing a note
    ...
    # 6. Expected Result 2: Process the changes (empty metadata)
